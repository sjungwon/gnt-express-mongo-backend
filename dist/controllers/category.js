...
export const getCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const category = yield CategoryModel.find({}, {}, { sort: { title: 1 } });
...
export const getCategoryByTitle = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const addCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        //이미 존재하는지 확인
        const dupCategory = yield CategoryModel.findOne({ title }).exec();
        if (dupCategory) {
        ...
        const resData = yield CategoryModel.findById(newCategory._id);
...
const deleteCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        //존재하는 카테고리인지 확인
        const category = yield CategoryModel.findById({
            _id: categoryId,
        });
        if (!category) {
        ...
        const profiles = yield ProfileModel.find({ category: categoryId });
        if (profiles.length) {
        ...
        const posts = yield PostModel.find({ category: categoryId });
        if (posts.length) {
            return res.status(403).json({
                type: "unauthorized request",
                error: "can't delete category with content",
        ...
        yield CategoryModel.findByIdAndRemove(categoryId);
